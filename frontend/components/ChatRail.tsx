  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: isUser ? "flex-end" : "flex-start", gap: 4 }}>
      <div style={{
        ...
        color: isUser ? "var(--fg-on-accent)" : "var(--fg1)",
...
export default function ChatRail() {
  const [collapsed, setCollapsed] = useState(() => {
    ...
    return localStorage.getItem("mm-chat-collapsed") === "true";
  });
    ...
    <aside style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 2, position: "relative" }} ref={settingsRef}>
          ...
          <IconBtn icon="chevronRight" onClick={toggle} title="Collapse" />
                ...
                <div style={{ display: "flex", gap: 4 }}>
                  {(["brief", "normal", "detailed"] as const).map((v) => (
                    <button key={v} onClick={() => setVerbosity(v)} style={{
                      ...
                      fontFamily: "var(--sans)", fontSize: 11, fontWeight: 500, capitalize: "capitalize",
